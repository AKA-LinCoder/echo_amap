/// FileName echo_amap_util-platform_interface
///
/// @Author LinGuanYu
/// @Date 2023/4/3 18:39
///
...
import 'echo_amap_util_method_channel.dart';

abstract class EchoAmapUtilPlatform extends PlatformInterface {
  /// Constructs a EchoAmapPlatform.
  EchoAmapUtilPlatform() : super(token: _token);

  static final Object _token = Object();

  static EchoAmapUtilPlatform _instance = MethodChannelEchoAmapUtils();

  /// The default instance of [EchoAmapPlatform] to use.
  ///
  /// Defaults to [MethodChannelEchoAmap].
  static EchoAmapUtilPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [EchoAmapPlatform] when
  /// they register themselves.
  static set instance(EchoAmapUtilPlatform instance) {
